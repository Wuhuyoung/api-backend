...
CREATE TABLE `interface_info`  (
                                   ...
                                   `method` varchar(255) CHARACTER SET utf8mb4   NOT NULL COMMENT '请求类型',
                                   `url` varchar(512) CHARACTER SET utf8mb4   NOT NULL COMMENT '接口地址',
                                   `request_params` text CHARACTER SET utf8mb4   NULL COMMENT '请求参数',
                                   `request_header` text CHARACTER SET utf8mb4   NULL COMMENT '请求头',
                                   `response_header` text CHARACTER SET utf8mb4   NULL COMMENT '响应头',
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4   COMMENT = '接口' ROW_FORMAT = Dynamic;
...
CREATE TABLE `post`  (
                         ...
                         `education` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '学历',
                         `place` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '地点',
                         `job` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '职业',
                         `contact` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '联系方式',
                         `love_exp` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '感情经历',
                         `content` text CHARACTER SET utf8mb4   NULL COMMENT '内容（个人介绍）',
                         `photo` varchar(1024) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '照片地址',
                         `review_status` int NOT NULL DEFAULT 0 COMMENT '状态（0-待审核, 1-通过, 2-拒绝）',
                         `review_message` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '审核信息',
                         ...
                         PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4   COMMENT = '帖子' ROW_FORMAT = Dynamic;
...
CREATE TABLE `soul_soother`  (
                                 `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
                                 `content` text CHARACTER SET utf8mb4   NULL COMMENT '文案',
                                 PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4   COMMENT = '心灵鸡汤' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
                         `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
                         `user_name` varchar(256) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '用户昵称',
                         `user_account` varchar(256) CHARACTER SET utf8mb4   NOT NULL COMMENT '账号',
                         `user_avatar` varchar(1024) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT '用户头像',
                         `gender` tinyint NULL DEFAULT NULL COMMENT '性别',
                         `user_role` varchar(256) CHARACTER SET utf8mb4   NOT NULL DEFAULT 'user' COMMENT '用户角色：user / admin',
                         `user_password` varchar(512) CHARACTER SET utf8mb4   NOT NULL COMMENT '密码',
                         `access_key` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT 'accessKey',
                         `secret_key` varchar(512) CHARACTER SET utf8mb4   NULL DEFAULT NULL COMMENT 'secretKey',
                         `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                         `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                         `is_delete` tinyint NOT NULL DEFAULT 0 COMMENT '是否删除',
                         PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4  COMMENT = '用户' ROW_FORMAT = Dynamic;
